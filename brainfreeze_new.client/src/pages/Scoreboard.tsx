...
export default function Scoreboard() {
    ...
    const [sortConfig, setSortConfig] = useState<{ key: keyof Score; direction: 'desc' | 'asc' } | null>(null);

    useEffect(() => {
        fetch(`${backendUrl}Scoreboards`)
    ...
    const handleSort = (key: keyof Score) => {
        ...
        const updatedScores = sortedScores.map((score, index) => ({
            ...score,
            place: direction === 'asc' ? scores.length - index : index + 1,
        }));
